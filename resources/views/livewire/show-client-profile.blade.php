    ...
    <table id="clients" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          {{$result->Name}}
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                    <a href="{{route('clients', $result->ClientID)}}" class="flex items-center mr-2 px-4 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> 

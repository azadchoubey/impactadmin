<div style="background-color:white;">
    ...
    <div class="flex flex-col items-center mb-4">
        ...
        <div id="validation-message" class="text-red-500 mt-2 hidden"></div>
   ...
   $(selectElement).empty().append(options);
    ...
    function apply_filters(condition) {
        ...
        $('#add_comment').click(function(e) {
            ...
            validationMessage.text('').addClass('hidden');

        if (comment === '') {
            validationMessage.text('Comment cannot be empty.').removeClass('hidden');
            return;
        }
        document.getElementById('processModal').classList.remove('hidden');
            ...
            jQuery.ajax({
                ...
                validationMessage.text('An error occurred while adding your comment. Please try again.').removeClass('hidden');
            }
            });
        });
</script>
